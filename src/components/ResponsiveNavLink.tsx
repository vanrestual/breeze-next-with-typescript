    ...
    return (
        <Link
            className={clsx(
                ...
                'focus:outline-hidden flex w-full items-start border-l-4 py-2 pe-4 ps-3 text-base font-medium leading-5 transition duration-150 ease-in-out',
            )}
            {...props}
        />
    )
